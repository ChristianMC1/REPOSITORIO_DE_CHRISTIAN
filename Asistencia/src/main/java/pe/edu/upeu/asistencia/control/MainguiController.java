...
public class MainguiController {
    ...
    @FXML
    private MenuItem menuItem1, menuItem2, menuItemC; // tienes que vincular este private con el public initialize y sus menus.
...
comboBoxEstilo.setOnAction(event -> cambiarEstilo());
    ...
    public void cambiarEstilo() {
        ...
        switch (estilo) {
            case "Estilo Oscuro":
                scene.getStylesheets().add(getClass().getResource("/css/css/estilo-oscuro.css").toExternalForm());
                break;
            case "Estilo Azul":
    ...
    class MenuItemListener {
        ...
        public void abrirArchivoFxml(String rutaArchivo, String titulo) {
            try {
                ...
                scrollPane.setFitToWidth(true); //Para almacenar mayor cantidad de datos, manejas la barra de abajo y arriba
