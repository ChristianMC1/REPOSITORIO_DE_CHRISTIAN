...
public interface ProductoRepository extends JpaRepository<Producto,Long> {
    ...
    @Query(value = "SELECT p.* FROM upeu_producto p WHERE p.nombre like:filter", nativeQuery = true) //Consulta SQL
    ...
    @Query(value = "SELECT p FROM Producto p WHERE p.nombre like:filter") //
